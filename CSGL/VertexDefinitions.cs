...
namespace CSGL
{
	...
	public sealed class VertexInformation
	{
		...
		public VertexInformation(Type type, params VertexAttribute[] attributes) 
		{
			this.Type = type;
			this.SizeInBytes = 0;
	...
	public readonly struct VertexPositionColour
	{
		...
		public static readonly VertexInformation VertexInfo = new VertexInformation(
			typeof(VertexPositionColour),
			new VertexAttribute("Position", 0, 3, 0),
			new VertexAttribute("Colour", 1, 4, 3 * sizeof(float))
			);

		public VertexPositionColour(Vector3 Position, Color4 Color)
		{
